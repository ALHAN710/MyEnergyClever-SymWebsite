...
function init_charts() {
		...
		var lineChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					...
					borderColor: "rgba(63, 63, 63, 0.7)",//135, 197, 255
					pointBorderColor: "rgba(63, 63, 63, 0.7)",
					pointBackgroundColor: "rgba(63, 63, 63, 0.7)",
					pointHoverBackgroundColor: "#fff",
					pointHoverBorderColor: "rgba(220,220,220,1)",
					pointBorderWidth: 1,
					data: [31, 74, 6, 39, 20, 85, 7]
					...
					borderColor: "rgba(55, 159, 255, 0.70)",
					pointBorderColor: "rgba(55, 159, 255, 0.70)",
					pointBackgroundColor: "rgba(151,187,205, 0.70)",
					pointHoverBackgroundColor: "#fff",
					...
					borderColor: "rgba(240, 167, 135, 0.70)",
					pointBorderColor: "rgba(240, 167, 135, 0.70)",
					pointBackgroundColor: "rgba(240, 167, 135, 0.70)",
					pointHoverBackgroundColor: "#fff",
					pointHoverBorderColor: "rgba(151,187,205,1)",
					pointBorderWidth: 1,
			...
			options: {
				...
				*title: {
					display: true,
					text: 'Legend Position: ' + 'top'//legendPosition
				}*
			}
		...
		var lineChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					label: "SA",
					backgroundColor: "rgb(255, 255, 255, 0.0)",//"rgba(135, 197, 255, 0.31)",//38, 185, 154,
					borderColor: "rgba(55, 159, 255, 0.7)",//135, 197, 255
					pointBorderColor: "rgba(55, 159, 255, 0.7)",
					pointBackgroundColor: "rgba(55, 159, 255, 0.7)",
					pointHoverBackgroundColor: "#fff",
					pointHoverBorderColor: "rgba(220,220,220,1)",
					pointBorderWidth: 1,
					data: [31, 74, 6, 39, 20, 85, 7]
	...
	if ($('#CourbedeCharge').length) {
		...
		CourbedeCharge = new Chart(ctx, {
			type: 'line',
			data: {
				labels: ["2020-03-01 00:00:00",
					"2020-03-01 00:05:00",
					"2020-03-01 00:10:00",
					"2020-03-01 00:15:00",
					"2020-03-01 00:20:00",
				...
				datasets: [{
					...
					pointHoverBorderColor: "rgba(55, 159, 255,1)",//151,187,205,
					pointBorderWidth: 1,
					data: [82, 23, 66, 9, 99, 4, 2, 82, 23, 66, 9, 99,
				...
				*legend: {
				...
				scales: {
					xAxes: [{
						...
						scaleLabel: {
							display: true,
							labelString: moment('2020-04-07').format('MMM').toString()//'Mars'
						}
					}],
					yAxes: [{
						display: true,
	...
	if ($('#PowerConsumption').length) {
		...
		var mybarChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					label: 'Energie(kWh)',
					backgroundColor: "rgba(240, 167, 135, 0.70)",//"#26B99A",
					data: [82, 23, 66, 9, 99, 14, 12, 82]
				}]
			},
			...
			options: {
				...
				scales: {
					xAxes: [{
						...
						scaleLabel: {
							display: true,
							labelString: moment('2020-04-07').format('MMM')//'Mars'
						},
						*gridLines: {
